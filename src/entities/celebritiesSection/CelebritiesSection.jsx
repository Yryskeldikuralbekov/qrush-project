      ...
      <ul className='max-w-[90%] xl:container mx-auto flex justify-between flex-wrap text-[#e2ded3] md:gap-x-[20px] gap-y-[36px] md:gap-y-[87px] tablet:gap-y-[100px] mt-[60px] md:mt-[22px] mb-[28px] md:mb-[150px] tablet:mb-[150px] '>
        {celebrities &&
          celebrities?.map(celeb => (
            ...
            >
              <img
                className={`w-full h-[357px] sm:w-full sm:h-[450px] md:w-[645px] md:h-[682px] tablet:w-[266px] tablet:h-[293px] mx-auto xl:w-[520px] xl:h-[493px] lg:w-[400px] lg:h-[353px] rounded-t-[16px] md:rounded-[17px] lg:rounded-[30px] md:mt-[20px] ${isMobile1 ? 'w-[410px] h-[425px]' : isMobile2 ? 'w-[637px] h-[652px]' : ''}`}
                src={celeb.image}
                alt='celebImg'
              />
              <div
                className={`w-[333px] h-[10px] flex justify-center items-center flex-col sm:w-[510px] sm:mt-[500px] md:bg-opacity-0 md:w-[645px] tablet:w-[281px] lg:w-[381px] absolute text-center rounded-[5px] mt-[381px] md:mt-[756px] tablet:mt-[363px] xl:mt-[549px] lg:mt-[413px] ${isMobile1 ? 'w-[410px] mt-[460px]' : isMobile2 ? 'w-[627px]' : ''}`}
              >
                <h4
                  className={`font-bold text-[20px] text-[#f93822] md:text-[#e2ded3] sm:text-[22px] md:text-[25px] lg:text-[23px] xl:text-[30px] text-center`}
                >
                  {celeb.first_name}
                </h4>
                <p
