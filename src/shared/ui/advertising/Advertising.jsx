...
export const Advertising = props => {
  ...
  return (
    <section className='bg-cover bg-no-repeat  bg-center h-[130px] md:h-[258px] tablet:h-[250px] xl:h-[300px]  bg-gradient-to-t from-[#160503] from-0% via-black to-[#160503] text-center '>
