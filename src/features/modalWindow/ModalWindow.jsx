...
export const ModalWindow = ({ openModal, setOpenModal }) =>
  ReactDOM.createPortal(
    ...
    >
      ...
      >
        <p className='text-center text-[#FFF] text-[14px] sm:text-[15px] tablet:text-[18px] font-[500] pt-[60px] tablet:pt-[110px] max-w-[400px] tablet:max-w-[618px] mx-auto xl:text-[30px] xl:max-w-[918px] xl:pt-[98px] lg:text-[23px] '>
