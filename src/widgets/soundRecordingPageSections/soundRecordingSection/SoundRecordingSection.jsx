...
export const SoundRecordingSection = () => {
  ...
  return (
    <section
      className='relative w-full font-montserrat h-[520px] sm:h-[600px] tablet:h-[800px] bg-[#0000008a] xl:flex xl:justify-end lg:h-[735px] lg:flex lg:justify-end bg-no-repeat bg-cover'
      style={{
      ...
      <div className='mx-[20px] pt-[100px] sm:w-[700px] text-[#fff] sm:pt-[90px] tablet:pt-[0px] sm:mx-[50px] tablet:top-[90px] absolute lg:left-[100px] lg:top-[100px] lg:z-10'>
        ...
        {soundRecordingData.description &&
          soundRecordingData.description?.map(el => (
            <ul key={el.id}>
              <li>
                <p className='text-[14px] md:text-[20px] w-[330px] md:w-[450px] tablet:text-[25px] tablet:w-full font-[400] text-[#FFFFFF] md:text-[#B4B4B4] mb-[10px] md:mb-[12px] tablet:mb-[24px] lg:w-full'>
                  {el.desc}
                </p>
              </li>
            </ul>
